...
class ApologyDetailApiView(APIView):
    ...
    def get_object(self, apology_id, user_id):
        '''
        Helper method to get the object with given apology_id, and user_id
        '''
        try:
            return Apology.objects.get(id=apology_id, user = user_id)
        except Apology.DoesNotExist:
            return None

    # 3. Retrieve
    def get(self, request, apology_id, *args, **kwargs):
        '''
        Retrieves the Apology with given apology_id
        '''
        apology_instance = self.get_object(apology_id, request.user.id)
    ...
    # 4. Update
    def put(self, request, apology_id, *args, **kwargs):
        '''
    ...
    # 5. Delete
    def delete(self, request, apology_id, *args, **kwargs):
        '''
